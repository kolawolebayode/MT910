...
class Transactions(models.Model):
    ...
    nostro_account = models.CharField(max_length=30, blank=True)
    suspense = models.CharField(max_length=30, blank=True)
    team = models.CharField(max_length=30, blank=True)
    qm_processed = models.CharField( max_length=15, default='pending')
